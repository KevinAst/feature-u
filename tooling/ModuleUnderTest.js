...
switch (MODULE_PLATFORM) {
  ...
  case undefined:
    ...
    break;
  case 'bundle':  
    console.log(`*** Testing Module Platform found in: dist/feature-u.js (MODULE_PLATFORM: ${MODULE_PLATFORM})`);
    moduleUnderTest = moduleFromBundle;
    break;
  case 'bundle.min':  
    console.log(`*** Testing Module Platform found in: dist/feature-u.min.js (MODULE_PLATFORM: ${MODULE_PLATFORM})`);
...
// TODO: ?? retrofit to feature-u ... import moduleFromDevSrc    from '../src/index';
import moduleFromBundle    from '../dist/feature-u';
import moduleFromBundleMin from '../dist/feature-u.min';
import moduleFromLib       from '../lib/index';
import moduleFromEs        from '../es/index';
...
// TODO: ?? retrofit to feature-u ... generateActions is action-u
